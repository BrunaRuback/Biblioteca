...
public class Menu {
        ...
        do {
            ...
            switch (opcoes) {
                ...
                case 9: // TODO: relatorio alugueis 
                    ...
                    this.biblioteca.listarAlugueis();
    ...
    private void devolverLivro() 
    {
        ...
        String titulo = leString();
        Livro livro = biblioteca.acharLivroPeloTitulo(titulo);

        System.out.println("CPF do cliente que realizou o aluguel: ");
        String cpf = leString();
        Cliente clienteEscolhido = biblioteca.acharClientePeloCPF(cpf);

        biblioteca.encerrarAluguel(livro, clienteEscolhido);
    }
